        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview ">
            ...
            <?php 
              ...
              $querySub = "SELECT * FROM mst_sub_menu inner join mst_user_access on mst_user_access.id_sub_menu = mst_sub_menu.id_sub_menu where mst_sub_menu.id_menu = $menuId and mst_user_access.id_role = $id_role ORDER BY mst_sub_menu.nama_sub_menu ASC" ;
