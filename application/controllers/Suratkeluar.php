...
class Suratkeluar extends CI_Controller
{
    ...
    public function cetak_data($id_surat_keluar)
    {
        ...
        $data['surat_keluar']           = $this->main->get_data_three_join_where_array('mst_surat_keluar', 'mst_jenis', 'mst_surat_keluar.id_jenis = mst_jenis.id_jenis', 'mst_opd', 'mst_surat_keluar.id_opd = mst_opd.id_opd', 'mst_paraf', 'mst_surat_keluar.id_paraf = mst_paraf.id_paraf', $where);
